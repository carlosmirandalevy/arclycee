...
export class MenuPrincipal {
  ...
  dibujar(renderizador, ancho, alto, textos) {
    ...
    ctx.fillText(
      'v0.22.0 - Liceo Francés de Santo Domingo 2026',
      ancho / 2,
      alto - 15
    );
  ...
  _dibujarSubmenu(ctx, ancho, alto, textos) {
    ...
    if (this.submenuActivo === 'creditos') {
      ...
      const miembros = [
        ...
        'Rafael', 'Tom', 'Tea', 'Eduardo', 'Leonardo'
      ];
  ...
  seleccionarOpcion() {
    ...
    switch (opcion) {
      ...
      case 'documentacion':
        ...
        {
          const archivosDoc = { es: 'docs/', fr: 'docs/fr.html', en: 'docs/en.html' };
          const idiomaActual = this.codigosIdioma[this.idiomaIndice];
          const archivoDoc = archivosDoc[idiomaActual] || 'docs/';
