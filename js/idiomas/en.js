...
const en = {
  ...
  dialogos: {
    ...
    aldea: {
      ...
      cacique4: 'Our society has caciques like me, nitaínos who are the noble warriors, naborías who work the land, and behiques who heal and speak with the spirits.',
      cacique5: 'Talk to the villagers. Each one has much to teach you about our way of life.',
    ...
    santuario: {
      ...
      biologa6: 'There\'s an adult manatee trapped right now! Go to the ghost net to the east and press [E/Enter] to cut it. Quickly, but calmly!',
  ...
  bossCemi: {
    ...
    continuar: '[E/Enter] Begin',
    ciclo: 'Cycle',
    aturdido: 'The spirit is stunned!',
    atacar: '[E/Enter] Strike with Enriquillo\'s Sword',
  ...
  tutorial: {
    ...
    accion: 'Press E/Enter to interact with objects and characters',
  ...
  ui: {
    presionaE: 'Press E/Enter to continue',
    presionaESaltar: 'Press E/Enter to skip',
    cartelNoGrafiti: 'Do not write on the walls',
    cartelProteger: 'Protect the petroglyphs',
    eContinuar: '[E/Enter] Continue',
    eComenzar: '[E/Enter] Start',
    comenzar: 'Start',
    continuar: 'Continue',

    eHablar: '[E/Enter] Talk',
    eExaminar: '[E/Enter] Examine',
    eEntrar: '[E/Enter] Enter',
    eCurar: '[E/Enter] Heal',
    eAdoptar: '[E/Enter] Adopt',
    eExcavar: '[E/Enter] Dig',
    eAlerta: '[E/Enter] Alert!',
    eSospechoso: '[E/Enter] Suspect!',
    eLiberar: '[E/Enter] Free',
    eLiberarManati: '[E/Enter] Free manatee',
    ...
    controlesLago: 'WASD: move | E: talk | M: map',
    controlesMuseo: 'WASD: move | E: talk | M: map | I: inventory',
    controlesLFSD: 'WASD: move | E: talk | M: map | I: inventory | P: photos | L: quests',
    controlesCueva2: 'WASD: move | E: examine | M: map → Find the cenote to the east →',
    controlesCenote: 'WASD: swim | E: collect | M: map | ↑ surface = O₂',
    museoHombreNombre: '🏛️ Museo del Hombre Dominicano',
    cuevaOscuraNombre: '🔦 Dark Cave — Manantial de la Aleta',
    cenoteBuceoNombre: '🤿 Sacred Cenote — Manantial de la Aleta',
    ayudaTitulo: '🎮 Game Controls',
    ayudaCerrar: 'Press H or Esc to close',
    ayudaMovimiento: '— Movement —',
    ayudaMover: 'Move (up, left, down, right)',
    ayudaFlechas: 'Move (arrow keys)',
    ayudaEspacio: 'Space',
    ayudaSaltar: 'Jump (in caves)',
    ayudaInteraccion: '— Interaction —',
    ayudaAccion: 'Talk / Interact / Confirm',
    ayudaCancelar: 'Cancel / Exit menu',
    ayudaEspecial: 'Special ability (companion)',
    ayudaMenus: '— Menus —',
    ayudaInventario: 'Inventory / Backpack',
    ayudaMapa: 'Return to world map',
    ayudaReferencia: 'Reference map (Leaflet)',
    ayudaRegistro: 'Quest log',
    ayudaAyuda: 'Help (this screen)',
    ayudaFotos: '— Photos —',
    ayudaFoto: 'Take photo',
    ayudaSelfie: 'Take selfie',
    ayudaAlbum: 'Open photo album',
    ayudaCombate: '— In Combat —',
    ayudaCombateDesc: '← → Choose option | E Confirm | H Detailed help panel',
    ayudaMiniJuegos: '— Mini-games (Batú, Areíto, Rappel, Boss) —',
    ayudaMiniJuegosDesc: 'Esc / Q to exit at any time',
    ...
    presionaEContinuar: 'Press E/Enter to continue ▶',
