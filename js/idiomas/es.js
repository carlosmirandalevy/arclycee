...
const es = {
  ...
  lfsd: {
    ...
    eduardo1: '¿Sabías que solo hay 4 arqueólogos supervisando construcciones en todo el país?',
    eduardo2: 'Investigué las leyes dominicanas sobre patrimonio. La Ley 318 es clave.',
    eduardo3: 'El Estado tiene la responsabilidad de proteger los sitios arqueológicos.',
    eduardo4: 'En Francia, antes de construir, un equipo arqueológico revisa el terreno. ¡Aquí deberíamos hacer lo mismo!',
    eduardo5: 'Un mapa de riesgo arqueológico ayudaría a prevenir la destrucción de sitios.',
    eduardo6: 'Hablamos con el arqueólogo Wilton Khoury. ¡Nos contó cosas increíbles!',
    eduardo7: 'El aeropuerto de Pedernales se construyó sobre posibles restos taínos. Nadie los revisó.',
    eduardo8: 'Proteger el patrimonio no es solo cuestión de leyes, es cuestión de conciencia.',
  ...
  ui: {
    ...
    controlesMuseo: 'WASD: mover | E: hablar | M: mapa | I: inventario',
    controlesLFSD: 'WASD: mover | E: hablar | M: mapa | I: inventario | P: fotos | L: misiones',
    controlesCueva2: 'WASD: mover | E: examinar | M: mapa → Busca el cenote al este →',
    controlesCenote: 'WASD: nadar | E: recoger | M: mapa | ↑ superficie = O₂',
    museoHombreNombre: '🏛️ Museo del Hombre Dominicano',
    cuevaOscuraNombre: '🔦 Cueva Oscura — Manantial de la Aleta',
    cenoteBuceoNombre: '🤿 Cenote Sagrado — Manantial de la Aleta',
    // Overlay de ayuda (tecla H)
    ayudaTitulo: '🎮 Controles del Juego',
    ayudaCerrar: 'Presiona H o Esc para cerrar',
    ayudaMovimiento: '— Movimiento —',
    ayudaMover: 'Mover (arriba, izquierda, abajo, derecha)',
    ayudaFlechas: 'Mover (flechas)',
    ayudaEspacio: 'Espacio',
    ayudaSaltar: 'Saltar (en cuevas)',
    ayudaInteraccion: '— Interacción —',
    ayudaAccion: 'Hablar / Interactuar / Confirmar',
    ayudaCancelar: 'Cancelar / Salir de menú',
    ayudaEspecial: 'Habilidad especial (compañero)',
    ayudaMenus: '— Menús —',
    ayudaInventario: 'Inventario / Mochila',
    ayudaMapa: 'Volver al mapa del mundo',
    ayudaReferencia: 'Mapa de referencia (Leaflet)',
    ayudaRegistro: 'Registro de misiones',
    ayudaAyuda: 'Ayuda (esta pantalla)',
    ayudaFotos: '— Fotos —',
    ayudaFoto: 'Tomar foto',
    ayudaSelfie: 'Tomar selfie',
    ayudaAlbum: 'Abrir álbum de fotos',
    ayudaCombate: '— En Combate —',
    ayudaCombateDesc: '← → Elegir opción | E Confirmar | H Panel de ayuda detallado',
    ayudaMiniJuegos: '— Mini-juegos (Batú, Areíto, Rapel, Boss) —',
    ayudaMiniJuegosDesc: 'Esc / Q para salir en cualquier momento',
